function CHARACTER()
{
	...
	this.move = function(to, duration, refresh)
	{
		...
		moving = setInterval(function(){
			...
			if (new_position == null) {clearInterval(moving); delete position; which.m_origin = to; return;}
	...
	this.processPath = function(paths_array)
	{
		...
		setTimeout(function(){
			GAME.enableGameMenus();
			GAME.clearPaths();
		}, 700*paths_array.length + 100);
		console.log("FINAL DESTINATION", paths_array[paths_array.length - 1].square);
		this.m_noninterpolated = paths_array[0].square;
	};
